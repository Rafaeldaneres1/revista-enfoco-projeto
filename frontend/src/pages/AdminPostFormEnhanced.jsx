          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-2 rounded-lg border border-charcoal/10 focus:border-royal-blue focus:outline-none transition-colors"
                placeholder="Resumo da reportagem"
              />
            </div>
        ...
        <div className="enfoco-glass rounded-xl p-6 shadow-premium">
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              placeholder="Conteúdo da reportagem (Markdown suportado)"
            />
          </div>
        </div>
      </ScrollReveal>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded"
                />
                <span className="font-semibold text-charcoal">Destacar como Reportagem Principal</span>
              </label>
