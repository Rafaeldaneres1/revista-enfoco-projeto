...
const BackToTopButton = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-[5.25rem] right-5 z-[69] inline-flex h-11 w-11 items-center justify-center rounded-full border border-black/10 bg-white/92 text-charcoal shadow-[0_14px_34px_rgba(0,0,0,0.16)] backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:bg-charcoal hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-royal-blue sm:bottom-[6.25rem] sm:right-7 sm:h-12 sm:w-12 ${
